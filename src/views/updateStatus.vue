<template>
  <div>
    <b-container>
      ...
      <h1 style="text-shadow: 2px 2px 5px black;display: inline;font-size: 25px;">Update Payment</h1>
      <br>
      <br>
      ...
      <div style="border: 2px solid gray;border-radius: 10px;height: 250px;box-shadow: 5px 5px 5px #888888;">
        <b-row style="margin: 20px;">
          ...
          <div>
            <b-form-checkbox id="checkbox-1" v-model="otstatus" name="checkbox-1" value="1" unchecked-value="0">
              <div style="margin: 10px;font-size: 20px;">ยืนยันการจ่ายเงิน</div>
            </b-form-checkbox>
          </div>
        </b-row>
