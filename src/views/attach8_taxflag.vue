...
export default {
  ...
  methods: {
    ...
    async getAttach8() {
      ...
      await axios.post('http://localhost:4000/getdataattach82t4', from_to_welfare)
        .then(response => {
          console.log('resdata82', response.data.result);
          let dataexcel = response.data.result
          this.excelarrayattach82 = Object.values(dataexcel);
        })
      await axios.post('http://localhost:4000/getdataattach821t4', from_to_welfare)
        .then(response => {
      ...
      await axios.post('http://localhost:4000/getdataattach831t4', from_to)
        .then(response => {
      ...
      await axios.post('http://localhost:4000/getdataattach83t4', from_to)
        .then(response => {
