  ...
  <div>
    ...
    <b-container>
      <div style="display: inline;">
        <h1 style="text-shadow: 2px 2px 5px black;display: inline;font-size: 25px;">Previous Report</h1>
        <b-form-select
...
import attached7 from '../views/pattach7.vue'
import attached8 from '../views/pattach8.vue';
import attached9 from '../views/pattach9.vue';
