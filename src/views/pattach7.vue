...
export default {
  ...
  methods: {
    ...
    async getAttach7all() {
      ...
      await axios.post('http://localhost:4000/pgetdataattach7', from_to)
        .then(response => {
          console.log('resdataTnos', response.data.result);
          let dataexcel = response.data.result
          this.excelarrayattach7 = Object.values(dataexcel);
      ...
      await axios.post('http://localhost:4000/pgetdataattach72', from_to_welfare)
        .then(response => {
          console.log('resdatawelfare', response.data.result);
          let dataexcel = response.data.result
          this.excelarrayattach72 = Object.values(dataexcel);
      ...
      await axios.post('http://localhost:4000/pgetdataattach721', from_to_welfare)
        .then(response => {
          console.log('resdatawelfare', response.data.result);
          let dataexcel = response.data.result
          this.excelarrayattach721 = Object.values(dataexcel);
      ...
      await axios.post('http://localhost:4000/pgetdataattach731', from_to)
        .then(response => {
          console.log('resdatawelfare', response.data.result);
          let dataexcel = response.data.result
      ...
      await axios.post('http://localhost:4000/pgetdataattach73', from_to)
        .then(response => {
          console.log('resdatainstuctor', response.data.result);
          let dataexcel = response.data.result
          this.excelarrayattach73 = Object.values(dataexcel);
    ...
    async generatePDF(datas) {
      ...
      const fontSize = 17; //
      const textWidth = thaiFont.widthOfTextAtSize(this.titleattach7, fontSize);
